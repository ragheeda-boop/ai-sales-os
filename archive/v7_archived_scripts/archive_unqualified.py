...
from core.constants import FIELD_CONTACT_OWNER, FIELD_EMAIL_SENT, FIELD_STAGE
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(os.path.join(os.path.dirname(os.path.abspath(__file__)), "archive_unqualified.log"), encoding="utf-8"),
